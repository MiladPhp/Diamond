...
$config = ['admin' => [777997288,**ADMIN**],'channel' => "$channel",'channel2' => "$channel2",'channel3' => "$channel3"]; //ادیت کنید
//=====
define('API_KEY',"**5169523147:AAEJiqToB76m6ybpzNsrxVLIjOgyPBHIffM**"); //توکن فقط ادیت بشه
